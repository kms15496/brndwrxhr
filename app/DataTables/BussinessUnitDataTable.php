...
class BussinessUnitDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($banner) {
                $html = '
            <div class="d-flex">
                <a href="' . route('admin.bussiness-unit.edit', $banner->id) . '" class="btn btn-sm btn-primary mr-2">
     ...
     */
    public function query(BussinessUnit $model): QueryBuilder
    {
